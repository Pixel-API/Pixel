...
var ClientID = strings.TrimSpace(os.Getenv(AntigravityOAuthClientIDEnv))

// defaultClientSecret 可通过环境变量 ANTIGRAVITY_OAUTH_CLIENT_SECRET 配置
var defaultClientSecret = strings.TrimSpace(os.Getenv(AntigravityOAuthClientSecretEnv))
...
func getClientID() (string, error) {
	...
	if v, ok := os.LookupEnv(AntigravityOAuthClientIDEnv); ok {
