...
const (
	...
	// GeminiCLIOAuthClientIDEnv is the environment variable name for the Gemini CLI OAuth client ID.
	GeminiCLIOAuthClientIDEnv = "GEMINI_CLI_OAUTH_CLIENT_ID"

	// GeminiCLIOAuthClientSecretEnv is the environment variable name for the Gemini CLI OAuth client secret.
