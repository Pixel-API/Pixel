export default {
  ...
  userAccounts: {
    ...
    importWarning: 'Supported: Sub2API OAuth JSON, Codex-Manager ChatGPT token JSON, OpenAI Refresh Token, and Claude Session Key. API keys, URLs, upstream endpoints and cookies are rejected.',
    ...
    importInvalidFile: 'Invalid import file: expected an account array or a Sub2API export with accounts.',
  ...
  channelStatus: {
    ...
    quotaPool: {
      ...
      mineSubtitle: 'Summarizes quota and OpenAI OAuth window snapshots from accounts you own.',
      platformTitle: 'Platform Shared Capacity Pool',
      platformSubtitle: 'Summarizes platform public accounts and approved public shared accounts.',
      mineEmpty: 'You do not have any summarizable account quota or OpenAI OAuth snapshots yet.',
  ...
  admin: {
    ...
    revenue: {
      ...
      cards: {
        ...
        consumedRevenueMeta: '{requests} requests',
      ...
      breakdownHints: {
        consumers: 'Grouped by caller, showing platform usage revenue, cost, owner-share expense and net profit generated by each consumer. This is not the caller’s personal income.',
        shareOwners: 'Grouped by public account owner. Only external usage of that user-owned account is counted; owner self-use is excluded.',
        groups: 'Grouped by routing group, showing platform usage revenue, cost, owner-share expense and net profit.',
        accounts: 'Grouped by called account, showing platform usage revenue, cost, owner-share expense and net profit.',
        models: 'Grouped by requested model, showing platform usage revenue, cost, owner-share expense and net profit.'
      },
      table: {
        name: 'Name',
        requests: 'Requests',
      ...
      sharePolicy: {
        ...
        description: 'Configure owner and invite share ratios for public user-owned accounts. The platform automatically keeps the remainder, and changes apply only to later usage.',
        ...
        ownerShareHint: 'When another user consumes a public account, this ratio is applied to the consumer charge.',
        inviteShareHint: 'When an invited user consumes the shared account pool during the valid period, this ratio is credited to the inviter.',
        platformShareHint: 'Calculated automatically as 100% minus owner share and invite share.',
        saveHint: 'Saving applies the new global policy to later usage. Existing usage keeps its original settlement snapshot.',
      ...
      shareSettlements: {
        ...
        description: 'Audit every settlement created when another user consumes a public user-owned account, including request ID, consumer, owner, inviter, policy version and platform net profit.',
    ...
    groups: {
      ...
      form: {
        ...
        requiredAccountLevelHint: 'When set, this OpenAI pool only accepts and schedules accounts at the selected level.'
      },
    ...
    accounts: {
      ...
      quotaDashboard: {
        ...
        subtitle: 'Summarizes local quota by platform and account type; OpenAI OAuth uses cached Codex window snapshots.',
      ...
      credentialImportHint: 'Paste account credentials or import files. Admin credential import creates platform OAuth accounts.',
      credentialImportWarning: 'This entry only accepts official OAuth credentials: Sub2API OAuth JSON, Codex-Manager ChatGPT token JSON, OpenAI Refresh Token, and Claude Session Key. API keys, URLs, upstream endpoints and cookies are rejected. Admins can still manage other account types through Add Account or Data Import.',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          title: 'Invite Income',
          description: 'Existing users invite new ones; the inviter earns real-time balance income when invitees consume the shared account pool during the valid period.',
          enabled: 'Enable Invite Income',
          enabledHint: 'When off, the invite page is hidden, the aff parameter is ignored at signup, and later usage generates no invite income.',
          rebateRate: 'Legacy Recharge Rebate Rate',
          rebateRateHint: 'Legacy recharge rebates are disabled. Configure consumption invite share in the revenue share policy.',
          freezeHours: 'Legacy Rebate Freeze Period (hours)',
          freezeHoursDesc: 'Legacy recharge rebate freeze is disabled. Current invite income is credited directly to balance.',
          durationDays: 'Invite Income Duration (days)',
          durationDaysDesc: 'Calculated from invite binding time. Shared-pool usage generates invite income within this many days. 0 = permanent.',
          perInviteeCap: 'Legacy Per-Invitee Rebate Cap',
          perInviteeCapDesc: 'Legacy recharge rebate caps are disabled. Consumption invite sharing has no per-invitee cap.',
          bindInviter: {
            title: 'Bind Invite Relationship',
            description: 'Admins can bind or replace a user’s inviter. Normal users cannot modify an existing binding.',
            invitee: 'Invitee',
            inviter: 'Inviter',
          ...
          customUsers: {
            ...
            description: 'Set a custom invite code for specific users. The consumption invite share ratio is configured in the revenue share policy.',
            addButton: 'Add Custom User',
            searchPlaceholder: 'Search by email or username',
            batchButton: 'Legacy Batch Set Rate ({count} selected)',
            empty: 'No users with custom affiliate settings yet',
            customBadge: 'custom',
            useGlobal: 'use global',
            resetTitle: 'Reset Custom Settings',
            resetMessage: 'Reset the custom invite code for {email}? The old invite link will stop working.',
          ...
          modal: {
            ...
            rateLabel: 'Legacy Exclusive Rebate Rate (optional)',
            ratePlaceholder: 'e.g. 30',
            rateHint: 'Legacy recharge rebate rates are disabled. Configure consumption invite sharing in the revenue share policy.',
            errorBadRate: 'Please enter a number between 0 and 100',
            errorEmpty: 'Enter a custom invite code',
          },
          batchModal: {
            title: 'Legacy Batch Set Rate ({count} users selected)',
            hint: 'Legacy recharge exclusive rebate rates are disabled.',
            placeholder: 'e.g. 30',
      ...
      defaults: {
        ...
        privateGroupTemplateHint: 'Default quota for private subscription groups created during user signup. 0 means unlimited.',
      ...
      customMenu: {
        ...
        openInNewWindowHint: 'When enabled, clicking this sidebar item opens the page URL in a new browser window instead of entering the embedded page.',
        add: 'Add Menu Item',
        remove: 'Remove',
        moveUp: 'Move Up',
        moveDown: 'Move Down',
